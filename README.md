...
V3 and V4 overlap the outgoing and incoming grids (no empty frame between
them) and stagger across columns as well as rows, so their wave shows on the
2-card and 1-card collections too. V1/V2 run in sequence and stagger by row.
